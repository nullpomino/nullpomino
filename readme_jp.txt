...
NAVIGATION UP：メニュー画面でカーソルを上に移動
NAVIGATION DOWN：メニュー画面でカーソルを下に移動
NAVIGATION LEFT：メニュー画面でカーソルで選択している項目の値を1つ減らす
NAVIGATION RIGHT：メニュー画面でカーソルで選択している項目の値を1つ増やす
NAVIGATION SELECT：メニュー画面での決定
NAVIGATION CANCEL：メニュー画面でのキャンセル
