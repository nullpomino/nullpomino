 ...
 */
public class PoochyBotPrethink extends DummyAI implements Runnable {
	/** ログ */
	static Logger log = Logger.getLogger(PoochyBotPrethink.class);
	...
	public String getName() {
		return "PoochyBot (Pre-think beta) V1.22b";
	}
